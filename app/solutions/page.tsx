...
export default function SolutionsPage() {
  return <main><Header />
    ...
    <section className="solutions-editorial shell" aria-label="צוות Extreme בעבודה משותפת">
      <figure><img src="/solutions-team-delivery.png" alt="צוות רב־תחומי מתכנן יחד תהליך גיוס ופרויקט טכנולוגי" width="1672" height="941" /><figcaption><strong>צוות אחד.<br />מתוצאה עסקית לביצוע.</strong><span>FOCUS × TALENT × TECHNOLOGY<br />DELIVERED TOGETHER</span></figcaption></figure>
    </section>
