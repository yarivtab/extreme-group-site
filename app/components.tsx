...
export function Header() {
  return <header className="site-header"><div className="shell nav-wrap">
    <Link href="/" className="brand" aria-label="Extreme Group דף הבית"><span className="brand-mark">X</span><span>EXTREME<small>GROUP</small></span></Link>
