...
export function Header() {
  return <header className="site-header"><div className="shell nav-wrap">
    <Link href="/" className="brand" aria-label="Extreme Group דף הבית"><Image className="brand-logo" src="/extreme-logo.png" alt="Extreme" width={238} height={46} priority /></Link>
